 ...
 */
export default function DateFilter({ onDateChange, autoLoad = true }: DateFilterProps) {
  ...
  // Classe para inputs sem ícone
  const inputWithoutIconClass = `${inputBaseClass} px-3`;
