...
// ✅ Seguro e com o mesmo resultado
...
interface ChartTooltipContentProps
  extends Omit<
    React.ComponentProps<typeof RechartsPrimitive.Tooltip<ValueType, NameType>>,
    'content'
  > {
  hideLabel?: boolean
  ...
  labelFormatter?: (
    label: any,
    payload: readonly RechartsPayload<ValueType, NameType>[]
  ) => React.ReactNode
  formatter?: (
    value: ValueType,
    name: NameType,
  ...
  color?: string
  label?: string | number | ((label: any) => React.ReactNode)
  active?: boolean
  payload?: any[]
}
