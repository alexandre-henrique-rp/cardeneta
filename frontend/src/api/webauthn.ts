 ...
 */
export const getRegistrationChallenge = async (): Promise<PublicKeyCredentialCreationOptionsJSON> => {
 ...
 */
export const verifyRegistration = async (body: RegistrationResponseJSON): Promise<void> => {
 ...
 * Essas opções são então passadas para a API WebAuthn do navegador.
 */
export const getLoginChallenge = async (): Promise<PublicKeyCredentialRequestOptionsJSON> => {
